        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers().AddNewtonsoftJson(setupAction =>
                                { 
                                    ...
                                    setupAction.SerializerSettings.TypeNameHandling = Newtonsoft.Json.TypeNameHandling.Auto;
                                    setupAction.SerializerSettings.Converters.Add(new CompanyConverter());
                                });
